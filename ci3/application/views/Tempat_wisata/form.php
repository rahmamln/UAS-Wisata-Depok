...
<h2>Form Input Tempat Wisata</h2>
          <?php echo form_open("tempat_wisata/save") ?>
            ...
            <div class="form-group row">
              ...
              <div class="col-6">
                <div class="input-group">
                  ...
                  <input id="latlong" name="latlong" type="text" required="required" class="form-control">
                </div>
              </div>
            </div>
            <div class="form-group row">
              <label for="jenis_id" class="col-3 col-form-label">Id Jenis</label> 
              <div class="col-6">
            ...
            <div class="form-group row">
              <label for="skor_rating" class="col-3 col-form-label">Skor / Rating</label> 
              <div class="col-6">
                <div class="input-group">
                  <div class="input-group-prepend">
                    <div class="input-group-text">
                  ...
                  <input id="skor_rating" name="skor_rating" type="text" class="form-control" required="required">
                </div>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              <label for="kecamatan_id" class="col-3 col-form-label">Id Kecamatan</label> 
              <div class="col-6">
